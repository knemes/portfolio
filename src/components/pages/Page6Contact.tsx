    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start max-w-6xl mx-auto">
          ...
          <form onSubmit={handleFormSubmit} className="space-y-3 bg-white p-5 border border-[#1A1A1A]/15 rounded-none shadow-sm relative">
            ...
            {formSubmitted && (
              <div className="absolute inset-0 bg-[#F4F1EA]/95 backdrop-blur rounded-none flex flex-col items-center justify-center text-center p-6 z-20">
                ...
                <p className="text-sm text-[#1A1A1A]/60 max-w-xs mt-1 leading-relaxed font-serif italic">
              ...
              <div className="flex gap-2 items-center my-1 bg-[#F4F1EA]/50 p-1 px-2 border border-[#1A1A1A]/5">
                {[1, 2, 3, 4, 5].map((starVal) => (
                  <button
                    ...
                    className="p-1 focus:outline-none transition-all hover:scale-110 cursor-pointer border-none bg-transparent"
                  >
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                required
                className="w-full text-xs font-mono px-3 py-2 border border-[#1A1A1A]/15 rounded-none focus:outline-none focus:border-[#1A1A1A] bg-white/60 resize-none font-sans"
              />
            </div>
            ...
            <button
              ...
              type="submit"
              className="w-full py-2.5 bg-[#1A1A1A] hover:bg-[#2c2a29] text-white rounded-none text-xs font-mono font-semibold tracking-widest flex items-center justify-center gap-2 transition-all cursor-pointer shadow border-none"
            >
        ...
        <div className="lg:col-span-6 space-y-4 text-left">
          ...
          <div className="border border-[#1A1A1A]/15 bg-white rounded-none shadow-sm p-4 h-[385px] overflow-y-auto space-y-3 relative">
